...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("cognitio"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("cognitio://", Qt::CaseInsensitive))
    {
        uri.replace(0, 11, "cognitio:");
    }
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Cognitio-Qt") + " " + tr("version") + " " +
...
{
    app.setStyleSheet("QWidget        { background: rgb(21,21,21); }"
                      "QFrame         { border: none; }"
                      "QComboBox      { color: rgb(255,255,255); }"
                      "QComboBox QAbstractItemView::item { color: rgb(255,255,255); }"
                      "QPushButton    { background: rgb(10,175,107); color: rgb(232,232,232);  }"
                      "QDoubleSpinBox { background: rgb(255,255,255); color: rgb(63,67,72); border-color: rgb(194,194,194); }"
                      "QSpinBox       { background: rgb(255,255,255); color: rgb(63,68,72); border-color: rgb(194,194,194); }"
                      ...
                      "QMenu          { background: rgb(0,0,0); color: rgb(222,222,222); }"
                      ...
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: rgb(79,209,150); border-left-style: solid; border-left-width: 6px; }"
                      "QProgressBar   { color: rgb(149,148,148); border-color: rgb(79,209,150); border-width: 0px; border-style: solid; }"
                      "QProgressBar::chunk { background: rgb(79,209,150); }"
                      "QTreeView::item { background: rgb(41,44,48); color: rgb(212,213,213); }"
                      "QTreeView::item:selected { background-color: rgb(48,140,198); }"
                      "QTableView     { background: rgb(43,46,51); color: rgb(212,213,213); gridline-color: rgb(157,160,165); }"
