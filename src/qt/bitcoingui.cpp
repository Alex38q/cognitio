...
{
    resize(900, 520);
    setWindowTitle(tr("Cognitio") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("cognitio");
    setStyleSheet("#cognitio { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    if (!fUseBlackTheme)
    {
        ...
        {
            progressBar->setStyleSheet("QProgressBar { color: #ffffff;background-color: #e8e8e8; border: 0px solid grey; border-radius: 5px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #423926, stop: 1 #2e240e); border-radius: 5px; margin: 0px; }");
        }
    }
    ...
    statusBar()->setStyleSheet("#statusBar { color: #ffffff;border:0px; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #1c1c1c, stop: 1 #353535);  }");
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction->setToolTip(tr("Show general overview of your Cognitio wallet"));
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Cognitio address"));
    ...
    blockAction->setToolTip(tr("Explore the Cognitio Blockchain"));
   ...
   // connect(TradingAction, SIGNAL(triggered()), this, SLOT(gotoTradingPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/aboutcognitio"), tr("&About Cognitio"), this);
    aboutAction->setToolTip(tr("Show information about Cognitio"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Cognitio"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-weight:bold;} QToolButton:hover { background-color: #28443d } QToolButton:checked { background-color:  #28443d } QToolButton:pressed { background-color: #28443d } #tabs { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #353535, stop: 1 #1c1c1c);  }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Cognitio client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Cognitio client"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Cognitio address or malformed URI parameters."));
    }
